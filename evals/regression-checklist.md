...
- [ ] User-observed password replacement, configured hosted backend core loop, staging rollback, custom SMTP custody, telemetry, backups/restore, physical phones/AT/human checks, custom domain, and production approval remain `NOT RUN`.
