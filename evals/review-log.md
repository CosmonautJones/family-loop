...
- `b6e5c66` made the mock invitation test independent of wall-clock expiry. `44c481d` restored the high-severity dependency-audit gate while keeping Expo/React Native versions unchanged.
