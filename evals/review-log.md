...
- Independent Run 2 acceptance remains pending. Physical iOS Safari/Android Chrome, browser screen readers, reduced motion, and moderated older-adult testing remain `NOT RUN` and are not inferred.
