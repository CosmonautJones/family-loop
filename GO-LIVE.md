...
- Application and local lint tooling are integrated into `main` through `d104de89c0e8aefd6e9b8958917775eba32cadd5`. Live site: `https://loopedin-family.netlify.app`, release `0.1.0-eca9bb8f7be8`, environment `loopedin-staging`; it has not received this candidate.
...
2. Integration and local release packaging are complete. Authenticate to the existing Netlify project, explicitly approve promotion, and verify the deployed bytes against the prepared artifact. Preserve the prior immutable deployment for rollback.
