...
import { buildCreateEventFields, createEventDraft, summarizeDraftEvent } from '../features/events';
import { palette, spacing } from '../theme/tokens';

const draftFields = buildCreateEventFields(createEventDraft);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.heroCard}>
        ...
        <Text style={styles.heroTitle}>{createEventDraft.title}</Text>
        <Text style={styles.heroCopy}>{summarizeDraftEvent(createEventDraft)}</Text>
      ...
      <SurfaceCard>
        ...
        <View style={styles.chipRow}>
          {createEventDraft.invitees.map((invitee) => (
      ...
      <SurfaceCard>
        ...
        <Text style={styles.cardCopy}>{createEventDraft.coverTreatment}</Text>
