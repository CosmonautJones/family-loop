...
const media: MediaItem[] = [
  { id: 'media-lake-dock', eventId: 'event-lake-geneva', uri: 'https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=1200&q=80', caption: 'Everyone together by the lake', uploadedBy: 'person-maya', uploadedAt: '2026-06-14T15:20:00-05:00' },
  { id: 'media-lake-breakfast', eventId: 'event-lake-geneva', uri: 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?auto=format&fit=crop&w=1200&q=80', caption: 'Sunday breakfast before the drive home', uploadedBy: 'person-emma', uploadedAt: '2026-06-14T10:30:00-05:00' },
  { id: 'media-lake-sunset', eventId: 'event-lake-geneva', uri: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80', caption: 'Sunset from the porch', uploadedBy: 'person-noah', uploadedAt: '2026-06-13T20:15:00-05:00' },
];
