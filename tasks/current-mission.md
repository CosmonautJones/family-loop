...
- Hosted deployment, provider secrets/sender verification, Resend tracking settings, accepted/delivered status, inbox receipt, Auth SMTP, and real new-account acceptance remain `NOT RUN`; no real email was sent.
