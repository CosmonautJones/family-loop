...
Latest checkpoint: Exact source `2721a98ce6fc03a1263ebc5284d90ac936d2e571` is release `0.1.0-2721a98ce6fc`, application digest `3794214c24c33c82961fd9c96a66c9bf2fc9809e366bfb03f4ce31c138a4779a`, and immutable Netlify deploy `6a591b138c9727a4b2ca6d48`, published unchanged at `https://loopedin-family.netlify.app` on `2026-07-16T18:19:21.898Z`. Dedicated staging matches all nine reviewed migrations through `20260716150236_invitation_email_delivery`; Auth SMTP and the owner-only invitation sender are configured without exposing credentials. Hosted run `mailqa-mrnu92ro-be6d0bcc` proves owner-UI invitation creation/queueing, provider `delivered`, exact unwrapped displayed-message URL equality, separate signed-out existing-recipient acceptance across reload, session restoration, consumed-link denial/reload, exact membership-baseline restoration, and zero marked residue. Recovery provider delivery also passes, while Gmail inbox observation and password replacement do not. Earlier core-loop/private-media/Realtime/outsider, availability, telemetry, backup/restore, responsive-width, history, and rollback evidence remains valid; post-migration encrypted backup/isolated restore `29517385245` is GREEN with all nine migrations. Prior deploy `6a58e22e48d42235e0ea40e0` is the rollback target. Custom domain, production backend, personal site, and quarantined Supabase project remain unchanged.
...
- Main CI `29518737936` is GREEN at `2721a98ce6fc03a1263ebc5284d90ac936d2e571`; exact application digest `3794214c24c33c82961fd9c96a66c9bf2fc9809e366bfb03f4ce31c138a4779a` is immutable deploy `6a591b138c9727a4b2ca6d48`, published unchanged to canonical staging at `2026-07-16T18:19:21.898Z`. Release/runtime identity, CSP, cache policy, immutable asset, and missing-script `404` checks pass. Prior deploy `6a58e22e48d42235e0ea40e0` is the rollback target; custom domain, production backend, and personal site remain unchanged.
