...
- Provider acceptance/delivery, inbox receipt, Auth SMTP confirmation/recovery, and real new-account acceptance remain `NOT RUN`; no real email was sent. The immediate blocker is authenticated Supabase dashboard access for custom SMTP configuration.
