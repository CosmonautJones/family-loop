...
- Partially complete slices: OPORDs 002, 003, 005, 006, 008, 010, 012, 013, and 014 retain named missing criteria. OPORD 003's local password-recovery slice is complete; production recovery email and hosted redirect/rate-limit proof remain external. The largest remaining product gaps are realtime subscriptions, persisted reminder preference, and assistive-technology/human evidence.
